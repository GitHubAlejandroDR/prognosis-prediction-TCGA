...
# CODE_DIR = r"(/path_to_your_directory/prognosis-prediction-TCGA/code/)"
# RMDs_DIR = r"(/path_to_your_directory/prognosis-prediction-TCGA/RMDs/)"
# DATA_DIR = r"(/path_to_your_directory/prognosis-prediction-TCGA/data/raw/)"
# DATA_PROCESSED_DIR <- r"(/path_to_your_directory/prognosis-prediction-TCGA/data/processed/)"
# RESULT_DIR <- r"(/path_to_your_directory/prognosis-prediction-TCGA/results/)"
# PLOTS_DIR <- r"(/path_to_your_directory/prognosis-prediction-TCGA/plots/)"
...
# RAW_CLINICAL_PATIENT <- r"(/path_to_your_directory/prognosis-prediction-TCGA/data/raw/data_clinical_patient.txt)"
# RAW_CLINICAL_SAMPLE <- r"(/path_to_your_directory/prognosis-prediction-TCGA/data/raw/data_clinical_sample.txt)"
# RAW_GENOMIC <- r"(/path_to_your_directory/prognosis-prediction-TCGA/data/raw/data_mrna_seq_v2_rsem.txt)"
# RAW_METHYLATION <- r"(/path_to_your_directory/prognosis-prediction-TCGA/data/raw/data_methylation.txt)"
# RAW_MICROBIOME <- r"(/path_to_your_directory/prognosis-prediction-TCGA/data/raw/data_microbiome.txt)"
